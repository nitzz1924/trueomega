                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" placeholder="Product Name" name="productname" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="">
                                        ...
                                        <input type="text" id="propertyprice" name="regularprice" class="form-control" placeholder="Regular Price" value="" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="">
                                        ...
                                        <input type="text" id="propertyprice" name="saleprice" class="form-control" placeholder="Sale Price" value="" required>
                                    </div>
                                </div>
                            </div>
                        </form>
